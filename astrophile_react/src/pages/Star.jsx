		...
		<div>
			...
			<div className="mt-[150px] lg:w-[1000px] w-[700px] mx-auto p-5">
				...
				<div className="mb-10 flex flex-col items-center justify-center flex-wrap">
					<h1 className="font-bold text-3xl">Search Star</h1>
				...
				{isLoading ? (
					...
					<div>
						{(searchResults.length > 0 ? searchResults : stars).map((star) => (
							<div className="flex md:flex-row flex-col justify-center items-center shadow-md p-5 rounded-md mb-7 lg:w-[1000px] w-[650px] mx-auto" key={star.starId}>
								<div className="flex justify-center items-center w-[20%] mr-4 p-5">
									<img src={`http://localhost:8000/storage/stars/${star.starImage}`} alt="astronautImage" />
								</div>
								<div className="w-[80%] ml-4 text-black text-justify">
									<h1 className="text-2xl mb-3">{star.starName}</h1>
									<hr className="mb-3" />
									<div>
										<table>
											<tr>
										...
										<div>
											<Link to={`/detailStar/${star.starId}`}>
